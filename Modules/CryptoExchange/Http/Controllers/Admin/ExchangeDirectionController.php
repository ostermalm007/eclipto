...
class ExchangeDirectionController extends Controller
{
    ...
    public function getCurrency()
    {
        ...
        $fromCurrencies = \App\Models\Currency::where('type','LIKE', $currencyType.'%')->where('status', 'Active')->get();
        // If crypto_buy or sell - from currencies fiat then tocurrencies crypto & vice versa
        $toCurrencies = \App\Models\Currency::where('type','LIKE', $toCurrencyType.'%')->where('status', 'Active');
