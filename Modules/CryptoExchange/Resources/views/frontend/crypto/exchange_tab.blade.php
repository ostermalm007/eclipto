                ...
                @if (transactionTypeCheck())
                    <nav class="nav-dimension">
                        <div class="navmp nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                            <a class="nav-item nav-link bg-secondary c-off-white padding-a OpenSans-700 crypto crypto_buy {{ ($exchange_type == 'crypto_buy' ||  $exchange_type == 'crypto_sell') ? 'active' : ''}} "
                                id="nav-profile-tab" data-bs-toggle="tab" href="#nav-profile"
                                role="tab" aria-controls="nav-profile"
                                aria-selected="false" data-type="crypto_buy">{{ __('Buy / Sell') }}
                            </a>
                            <a class="nav-item nav-link bg-dark c-off-white padding-a OpenSans-700 crypto crypto_swap {{ ($exchange_type == 'crypto_swap') ? 'active' : '' }}"
                                id="nav-home-tab" data-bs-toggle="tab" href="#nav-home" role="tab"
                                aria-controls="nav-home" aria-selected="true" data-type="crypto_swap">{{ __('Swap') }} 
                            </a>
                        </div>
                    </nav>
                    ...
                    <nav class="nav-dimension">
                        <div class="navmp nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                            <a class="nav-item nav-link c-off-white padding-a OpenSans-700"
                                ...
                                aria-selected="true">{{ transactionTypeCheck('crypto_buy_sell') ? __('Buy / Sell') : __(' Swap') }}
                            </a>
                        </div>
                    </nav>
                @endif
                        ...
                        <div class="box-shadow tabpan-rad tab-pane  show active bg-light bg-5B"
                                    ...
                                    <div class="boxdiv yousend-top bg-light mx-28 mt-35 box-bg-one">
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <!-- Button trigger modal -->
                                                <div id="selected-from-currency" class="selected bg-secondary d-flex gap-20" data-bs-toggle="modal" data-bs-target=".bd-example-modal-sm">
                                                    @if($direction)
                                                        <button type="button" class="btn btn-secondary md:ms-2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2 col-2 d-flex align-items-center">
                                    <div
                                        class="buy-sell-btn display-flex justify-content-center align-items-center switch-box display-hide cur-pointer bg-secondary">
                                        ...
                                        <img src="{{ asset('public/frontend/templates/images/home/exchange.png') }}" height="25px">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="boxdiv bg-light mx-28 box-bg-two">
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <div id="selected-to-currency" class="selected bg-dark d-flex gap-20" data-bs-toggle="modal" data-bs-target=".bd-example-modal-sm-to">
                                                @isset($direction)
                                                <button type="button" class="btn btn-dark md:ms-2"  >
