                ...
                <div class="d-flex step-div-parent mt-mid-40p">
                    <div class="step-div ml-11n">
                        <div class="steper-div-2 d-flex">
                            ...
                            <div class=" d-flex align-items-center ml-19"><p class="align-items-center crypto-font-22 OpenSans-600 status-color mb-unset">{{ __('Choose Currencies') }}</p></div>
                        </div>
                        ...
                        <div class="steper-div-2 d-flex">
                            ...
                            <div class=" d-flex align-items-center ml-28"> <p class="crypto-font-22 OpenSans-600 status-color-active mb-unset">{{ __('Verify your Email') }}</p></div>
                        </div>
                        ...
                        <div class="steper-div-2 d-flex">
                            ...
                            <div class=" d-flex align-items-center ml-28"> <p class="crypto-font-22 OpenSans-600 status-color mb-unset">{{ __('Finish Transaction') }}</p></div>
                        </div>
                        <!-- status end for 4th_step_status-->
                    </div>
                </div>
