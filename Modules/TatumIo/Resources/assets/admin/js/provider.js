...
$(".crypto-dropdown").on('click', function() {
...
$("#crypto-search-icon").on('click', function() {
...
// Crypto Provider status change (TatumIo)
$(".provider-status").on('click', function() {
