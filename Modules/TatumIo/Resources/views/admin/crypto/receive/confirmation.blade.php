                    ...
                    <div class="col-md-7">
                        <div class="ml-0">
                            ...
                            <div class="float-right">
                                <form action="{{ route('admin.tatum.crypto_receive.success') }}" method="POST" id="admin-user-crypto-receive-confirm" novalidate="novalidate">
...
<script type="text/javascript">
    'use strict';
    var cryptoReceiveBackUrl= '{{ route("admin.tatum.crypto_receive.create", encrypt($network)) }}';
