...
@push('extra_body_scripts')
    ...
    <script type="text/javascript">
        ...
        var startToDate = "{!! $to !!}";
        var userNotFound = '{{ __("User Does Not Exist") }}';


    </script>
    <script src="{{ asset('Modules/TatumIo/Resources/assets/admin/js/crypto_sent_transaction.min.js') }}" type="text/javascript"></script>
