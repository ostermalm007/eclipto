    ...
    <div class="row mt-3">
        <div class="col-md-12">
            <div class="box box-info" id="crypto-receive-create">
                ...
                <form action="{{ route('admin.tatum.crypto_receive.confirm') }}" class="form-horizontal" id="admin-crypto-receive-form" method="POST">
...
<script type="text/javascript">
    'use strict';
    var network = '{{ $network }}';
    var userBalanceWithMerchantAddressUrl = '{{ route("admin.tatum.crypto_receive.network_balance") }}';
    var confirmationCryptoReceivedUrl = '{{ route("admin.tatum.crypto_receive.confirm") }}';
    var backButtonUrl = '{{ route("admin.crypto_providers.list", "TatumIo") }}';
    var validateBalanceUrl = '{{ route("admin.tatum.crypto_receive.validate_balance") }}';
    ...
    var high = '{{ __("High") }}';
    var tatumIoMinLimit = JSON.parse(@json($minTatumIoLimit));
</script>
