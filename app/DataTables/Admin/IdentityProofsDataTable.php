    ...
    public function ajax(): JsonResponse
    {
        return datatables()
            ...
            ->editColumn('created_at', function ($documentVerification) {
                ...
                return (Common::has_permission(auth('admin')->user()->id, 'edit_identity_verfication')) ? '<a href="' . url(config('adminPrefix') . '/identity-proofs/edit/' . $documentVerification->id) . '" class="btn btn-xs btn-primary"><i class="fa fa-edit"></i></a>&nbsp;' : '';
            })
