...
class DepositMoneyController extends Controller
{
     ...
     * @return JsonResponse
     */
    public function paymentConfirm(PaymentGatewayConfirmRequest $request): JsonResponse
    {
        try {
            return $this->successResponse($this->service->processGatewayPayment(
                $request->currency_id,
