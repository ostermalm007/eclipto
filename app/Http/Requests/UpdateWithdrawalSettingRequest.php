...
/**
 * @package UpdateWithdrawalSettingRequest
...
use App\Rules\WithdrawalSetting\{
    CheckDuplicateCryptoAddressUpdate,
    CheckDuplicatePayPalEmail
};
use Illuminate\Validation\Rule;

class UpdateWithdrawalSettingRequest extends CustomFormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'crypto_address'      => [
                                        ...
                                        new CheckDuplicateCryptoAddressUpdate
                                    ],
        ];
    }
     ...
     * @return array
     */
    public function validatedFromRequest()
    {
        switch (request()->type) {
            case Bank:
                $data = [
