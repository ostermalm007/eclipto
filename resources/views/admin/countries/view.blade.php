        ...
        <div class="col-md-9">
            <div class="box box_info">
                  <div class="d-flex align-items-center justify-content-between p-4">
                    ...
                    @if(Common::has_permission(auth('admin')->user()->id, 'add_country'))
                      <div><a class="btn btn-theme f-14 float-end" href="{{ url(config('adminPrefix').'/settings/add_country') }}">{{ __('Add Country') }}</a></div>
                    @endif
                  </div>
                  <hr>
