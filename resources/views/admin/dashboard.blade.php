...
@section('head_style') Dashboard @endsection
...
@section('extra_body_scripts')
    ...
    {{-- <script defer src="{{ asset('/') }}public/dashboard/js/apexcharts.js"></script>
    <script src="{{ asset('/') }}public/dashboard/js/dayjs.min.js"></script>
    <script>
...
@section('page_content')
    ...
    <div class="mb-6 grid grid-cols-1 mt-5 gap-6 text-white sm:grid-cols-2 xl:grid-cols-4">
      
        <!-- Bounce Rate -->
        <a href="#" class="panel bg-gradient-to-r from-fuchsia-500 to-fuchsia-400">
            <div class="flex justify-between">
                <h2 class="text-lg font-semibold ltr:mr-1 rtl:ml-1">Pending Transactions</h2>
                {{-- <div x-data="dropdown" @click.outside="open = false" class="dropdown">
                    ...
                    <ul x-show="open" x-transition="" x-transition.duration.300ms="" class="text-black ltr:right-0 rtl:left-0 dark:text-white-dark" style="display: none;">
                        <li><a href="{{ url(config('adminPrefix').'/address-proofs') }}" @click="toggle">View Details</a></li>
        ...
        <!-- Sessions -->
        <a href="{{ url(config('adminPrefix').'/address-proofs') }}" class="panel bg-gradient-to-r from-violet-500 to-violet-400">
            <div class="flex justify-between">
                <h2 class="text-lg font-semibold ltr:mr-1 rtl:ml-1">Pending Address Verfications</h2>
                {{-- <div x-data="dropdown" @click.outside="open = false" class="dropdown">
                    <a href="javascript:;" @click="toggle">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 opacity-70 hover:opacity-80">
                            <circle cx="5" cy="12" r="2" stroke="currentColor" stroke-width="1.5"></circle>
                    ...
                    <ul x-show="open" x-transition="" x-transition.duration.300ms="" class="text-black ltr:right-0 rtl:left-0 dark:text-white-dark" style="display: none;">
                        <li><a href="{{ url(config('adminPrefix').'/address-proofs') }}" @click="toggle">View Report</a></li>
                        <li><a href="javascript:;" @click="toggle">Edit Report</a></li>
                    </ul>
                </div> --}}
            </div>
            <div class="mt-5 flex items-center">
                <div class="text-3xl font-bold ltr:mr-3 rtl:ml-3">{{ $pendingIdentityVerifications }}</div>
        ...
        <!-- Time On-Site -->
        <a href="{{ url(config('adminPrefix').'/address-proofs') }}" class="panel bg-gradient-to-r from-blue-500 to-blue-400">
            <div class="flex justify-between">
                <h2 class="text-lg font-semibold ltr:mr-1 rtl:ml-1">Pending Identity Verifications</h2>
                {{-- <div x-data="dropdown" @click.outside="open = false" class="dropdown">
                    <a href="javascript:;" @click="toggle">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 opacity-70 hover:opacity-80">
                            <circle cx="5" cy="12" r="2" stroke="currentColor" stroke-width="1.5"></circle>
            ...
            <div class="mt-5 flex items-center">
                <div class="text-3xl font-bold ltr:mr-3 rtl:ml-3">{{ $pendingAddressVerifications }}</div>
        ...
        <div class="panel bg-gradient-to-r from-cyan-500 to-cyan-400">
            <div class="flex justify-between">
                <div class="text-md font-semibold ltr:mr-1 rtl:ml-1">Total Transactions</div>
                <div x-data="dropdown" @click.outside="open = false" class="dropdown">
                    <a href="javascript:;" @click="toggle">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 opacity-70 hover:opacity-80">
                            <circle cx="5" cy="12" r="2" stroke="currentColor" stroke-width="1.5"></circle>
    ...
    {{-- <div x-data="crypto">
        <div class="relative mt-5 flex flex-col gap-5 xl:flex-row">
            <div
                class="panel perfect-scrollbar absolute z-10 hidden w-80 flex-none divide-y divide-[#ebedf2] overflow-visible border-0 p-0 dark:divide-[#191e3a] lg:overflow-y-auto xl:relative xl:block"
            ...
            >
                <template x-for="item in coins">
                    <button
                        ...
                        :class="{'bg-gray-100 dark:bg-[#192A3A]' : selectedCoinObj.title === item.title}"
                        @click="selectBitCoin(item)"
                    >
                        <div class="ltr:pr-4 rtl:pl-4">
                            <div class="flex items-baseline font-semibold">
                                ...
                                <div class="text-xs uppercase text-white-dark" x-text="`(${item.alias})`"></div>
                            </div>
                            <div class="mt-2 flex items-center" :class="[item.isUp ? 'text-success' : 'text-danger']">
                                ...
                                <div class="text-sm font-medium" x-text="`${item.perc}%`"></div>
                            </div>
                        </div>
                        <div class="flex-1">
            ...
            <div class="panel flex-1 p-0">
                <div class="flex-wrap items-center border-b border-[#ebedf2] p-4 dark:border-[#191e3a] md:flex">
                    <div class="flex flex-1 items-start ltr:pr-4 rtl:pl-4">
                        <button
                            type="button"
                            class="block hover:text-primary ltr:mr-5 rtl:ml-5 xl:hidden"
                            @click="isShowCryptoMenu = !isShowCryptoMenu"
                        >
                        ...
                        <div>
                            <div class="flex items-center">
                                <div class="text-md font-semibold ltr:mr-1 rtl:ml-1" x-text="selectedCoinObj.title"></div>
                                <div class="text-xs font-semibold uppercase text-white-dark" x-text="`(${selectedCoinObj.alias})`"></div>
                            </div>
                    ...
                    >
                        <li class="px-4 py-1">
                            Market Cap
                            <span
                                class="mt-1.5 block text-lg text-black dark:text-white-light"
                                x-text="`$${selectedCoinObj.marketcap}B`"
                            ></span>
                        </li>
                        <li class="px-4 py-1">
                            Volume
                            <span class="mt-1.5 block text-lg text-black dark:text-white-light" x-text="`$${selectedCoinObj.volume}B`"> </span>
                        </li>
                        <li class="px-4 py-1">
                            Supply
                            <span class="mt-1.5 block text-lg text-black dark:text-white-light" x-text="`${selectedCoinObj.supply}M`"></span>
                        </li>
                        <li class="px-4 py-1">
                            All Time High
                            <span class="mt-1.5 block text-lg text-black dark:text-white-light" x-text="`$${selectedCoinObj.highest}`"></span>
                        </li>
                    </ul>
                </div>
                <div class="mb-5 grid grid-rows-1 gap-4 border-b border-[#ebedf2] p-4 dark:border-[#253b5c] sm:grid-cols-4">
                    ...
                    <div>
                        ...
                        <div class="relative flex">
                            ...
                            <div x-data="dropdown" @click.outside="open = false" class="dropdown">
                                <div
                                    class="flex cursor-pointer items-center justify-center gap-1 rounded-none border bg-[#f1f2f3] px-3 py-2 font-semibold ltr:rounded-r-md rtl:rounded-l-md dark:border-[#253b5c] dark:bg-[#1b2e4b]"
                                    @click="toggle"
                                >
                                    BTC
                                    <svg
