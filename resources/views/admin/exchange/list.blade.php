                    ...
                    <div class="col-md-12">
                        <div class="d-flex flex-wrap justify-content-between align-items-center">
                            <div class="d-flex flex-wrap">
                                <!-- Date and time range -->
                                <div class="pr-25">
                                    <label class="f-14 fw-bold mb-1" id="daterange-btn">{{ __('Date Range') }}</label><br>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            $('#csv').on('click', function(event) {
                ...
                window.location = SITE_URL + "/" + ADMIN_PREFIX + "/exchanges/csv?startfrom=" + startfrom +
                    "&endto=" + endto +
                    "&status=" + status +
                    "&currency=" + currency +
                    "&user_id=" + user_id;
        ...
        $(document).ready(function() {
            $('#pdf').on('click', function(event) {
                ...
                window.location = SITE_URL + "/" + ADMIN_PREFIX + "/exchanges/pdf?startfrom=" + startfrom +
                    "&endto=" + endto +
                    "&status=" + status +
                    "&currency=" + currency +
                    "&user_id=" + user_id;
