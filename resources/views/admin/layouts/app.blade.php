...
<html lang="en" dir="ltr">
	...
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8"/>
        ...
        <title>Eclipto Admin- @yield('title')</title>
	    <link rel="canonical" href="https://html.vristo.sbthemes.com/crypto.html" />
        ...
        <link rel="stylesheet" type="text/css" media="screen" href="{{ asset('/') }}public/dashboard/css/perfect-scrollbar.min.css" />
        <link rel="stylesheet" type="text/css" media="screen" href="{{ asset('/') }}public/dashboard/css/style.css" />
        <link defer rel="stylesheet" type="text/css" media="screen" href="{{ asset('/') }}public/dashboard/css/animate.css" />
        ...
        <script defer src="{{ asset('/') }}public/dashboard/js/popper.min.js"></script>
        <script defer src="{{ asset('/') }}public/dashboard/js/tippy-bundle.umd.min.js"></script>
        <script defer src="{{ asset('/') }}public/dashboard/js/sweetalert.min.js"></script>
        ...
        <div class="main-container min-h-screen text-black dark:text-white-dark" :class="[$store.app.navbar]">
                    ...
                    <div class="h-full bg-white dark:bg-[#0e1726]">
                        <div class="flex items-center justify-between px-4 py-3">
                            <a href="{{ url('/') }}" class="main-logo flex shrink-0 items-center">
                                <img class="ml-[5px] flex-none" src="{{ asset('/') }}public/assets/images/logo/logo.png" style="height: 40px" alt="image" />
                        ...
                        >
                            ...
                            <li class="nav-item">
                                <ul>
                                    ...
                                    <li class="nav-item">
                                        <a href="{{ url(config('adminPrefix').'/home') }}" class="group  {{ preg_match('(home)', request()->url())==1 ? 'active' : '' }}">
                                            <div class="flex items-center">
                                                <svg
                                                    class="shrink-0 group-hover:!text-primary"
                                                    width="20"
                                                ...
                                                <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{{ __('Dashboard') }}</span>
                                            </div>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{ url(config('adminPrefix').'/settings/currency') }}" class="group  {{ preg_match('(settings/currency)', request()->url())==1 ? 'active' : '' }}">
                                            <div class="flex items-center">
                                                ...
                                                <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{{ __('Currencies') }}</span>
                                            </div>
                                        </a>
                                    </li>

                                    <li class="nav-item">
                                        <a href="{{ url(config('adminPrefix').'/blogs') }}" class="group {{ preg_match('(blog)', request()->url())==1 ? 'active' : '' }}">
                                            <div class="flex items-center">
                                                <svg class="shrink-0 group-hover:!text-primary" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{{ __('Blogs') }}</span>
                                            </div>
                                        </a>
                                    </li>
                                    ...
                                    <li class="nav-item">
                                        <a href="{{ url(config('adminPrefix').'/settings/pages') }}" class="group  {{ preg_match('(page)', request()->url())==1 ? 'active' : '' }} ">
                                            <div class="flex items-center">
                                                <svg class="shrink-0 group-hover:!text-primary" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{{ __('Pages') }}</span>
                                            </div>
                                        </a>
                                    </li>
                                    ...
                                    @if(Common::has_permission(auth()->guard('admin')->id(), 'view_identity_verfication') || Common::has_permission(auth()->guard('admin')->id(), 'view_address_verfication'))
                                        @php
                                            $isVerificationMenuActive=false;
                                            if(
                                                preg_match('(identity-proofs)', request()->url())==1 || 
                                                preg_match('(address-proofs)', request()->url())==1 
                                            ){
                                                $isVerificationMenuActive=true;
                                            }
                                        @endphp
                                        <li class="menu nav-item">
                                            <button
                                                type="button"
                                                class="nav-link group {{ $isVerificationMenuActive?'active':'' }}"
                                            ...
                                            >
                                                <div class="flex items-center">
                                                    ...
                                                    <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{{ __('Verifications') }}</span>
                                                </div>
                                            ...
                                            <ul x-cloak x-show="activeDropdown === 'invoice'" x-collapse class="sub-menu text-gray-500">
                                                @if(Common::has_permission(auth()->guard('admin')->id(), 'view_identity_verfication'))
                                                    <li>
                                                        <a href="{{ url(config('adminPrefix').'/identity-proofs') }}" class="{{ preg_match('(identity-proofs)', request()->url())==1 ? 'active' : '' }}">{{ __('Identity Verification') }}</a>
                                                    </li>
                                                @endif

                                                @if(Common::has_permission(auth()->guard('admin')->id(), 'view_address_verfication'))
                                                    <li>
                                                        <a href="{{ url(config('adminPrefix').'/address-proofs') }}" class="{{ preg_match('(address-proofs)', request()->url())==1 ? 'active' : '' }}">{{ __('Address Verification') }}</a>
                                                    </li>
                                                @endif
            ...
            <div class="main-content flex min-h-screen flex-col">
                    ...
                    <div class="shadow-sm">
                        <div class="relative flex w-full items-center bg-white px-5 py-2.5 dark:bg-[#0e1726]">
                            <div class="horizontal-logo flex items-center justify-between ltr:mr-2 rtl:ml-2 lg:hidden">
                                <a href="{{ url('/') }}" class="main-logo flex shrink-0 items-center">
                                    <img class="inline ltr:-ml-1 rtl:-mr-1" src="{{ asset('/') }}public/assets/images/logo/logo.png" style="height: 40px" alt="image" />
                            ...
                            >
                                ...
                                <div class="dropdown shrink-0" x-data="dropdown" @click.outside="open = false">
                                    ...
                                    >
                                        <img
                                            :src="`{{ asset('/') }}public/dashboard/images/flags/${$store.app.locale.toUpperCase()}.svg`"
                                            alt="image"
                                        ...
                                        <template x-for="item in languages">
                                            <li>
                                                ...
                                                >
                                                    <img
                                                        class="h-5 w-5 rounded-full object-cover"
                                                        :src="`{{ asset('/') }}public/dashboard/images/flags/${item.value.toUpperCase()}.svg`"
                                                        alt="image"
                                                    />
                                                    ...
                                                    <div class="grid place-content-center rounded">
                                                        <div class="relative h-12 w-12">
                                                            <img
                                                                ...
                                                                :src="`{{ asset('/') }}public/dashboard/images/${notification.profile}`"
                                                                alt="image"
                                                            />
                                    ...
                                    <a href="javascript:;" class="group relative" @click="toggle()">
                                        <span
                                            ><img
                                                ...
                                                src="{{ asset('/') }}public/dashboard/images/user-profile.jpg"
                                                alt="image"
                                        /></span>
                                    </a>
                                    <ul
                                    ...
                                    >
                                        {{-- <li>
                                            <div class="flex items-center px-4 py-4">
                                                <div class="flex-none">
                                                    <img class="h-10 w-10 rounded-md object-cover" src="{{ asset('/') }}public/dashboard/images/user-profile.jpg" alt="image" />
                                                </div>
                                        ...
                                        <li class="border-t border-white-light dark:border-white-light/10">
                                            <a href="{{ url(config('adminPrefix').'/adminlogout') }}" class="!py-3 text-danger" @click="toggle">
                                                <svg
                    ...
                    <div class="grid grid-cols-1 gap-6 pt-5 lg:grid-cols-2">
                        ...
                        <div class="">
                            <ul class="flex space-x-2 rtl:space-x-reverse">
                                <li>
                                    <a href="{{ url('/admin/home') }}" class="text-primary hover:underline">Eclipto Admin</a>
                                </li>
                                @yield('breadcrumbs')
                            </ul>
                        </div>
                ...
                <div class="mt-auto p-6 pt-0 text-center dark:text-white-dark ltr:sm:text-left rtl:sm:text-right">
                    © <span id="footer-year">{{ date('Y') }}</span>. Eclipto All rights reserved.
                </div>
                <!-- end footer section -->
            </div>
        </div>
        <script src="{{ asset('/') }}public/dashboard/js/alpine-collaspe.min.js"></script>
        <script src="{{ asset('/') }}public/dashboard/js/alpine-persist.min.js"></script>
        <script defer src="{{ asset('/') }}public/dashboard/js/alpine-ui.min.js"></script>
        <script defer src="{{ asset('/') }}public/dashboard/js/alpine-focus.min.js"></script>
        <script defer src="{{ asset('/') }}public/dashboard/js/alpine.min.js"></script>
