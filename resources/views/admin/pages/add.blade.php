...
@section('page_content')
  <div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="box-body">
          <div class="row">
            ...
            <div class="col-md-2">
              ...
              <a href="{{  url(config('adminPrefix')."/settings/pages") }}" class="btn btn-block btn-default btn-flat btn-border-orange f-14">{{ __('Pages') }}</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="box-body">
        <!-- /.box-header -->
        <form action="{{url(config('adminPrefix').'/settings/page/store')}}" method="POST" id="page" class="form-horizontal" enctype="multipart/form-data">
           {{ csrf_field() }}
