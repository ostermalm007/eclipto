      ...
      <div class="col-md-9">
          ...
          <div class="box box-info">
              <div class="box-header with-border">
                  <h3 class="box-title">{{ __('Edit User Group') }}</h3>
              </div>

              <!-- form start -->
              <form method="POST" action="{{ url(config('adminPrefix').'/settings/edit_user_role/'. $result->id) }}"
                  ...
                  <div class="box-body">
                      ...
                      <div class="form-group row">
                          ...
                          <div class="col-sm-6">
                              <input placeholder="{{ __('Display Name') }}" type="text" class="form-control f-14" name="display_name"
                      ...
                      <div class="form-group row">
                        <label class="col-sm-3 control-label mt-11 f-14 fw-bold text-sm-end" for="customer_type">{{ __('User Type') }}</label>
                        <div class="col-sm-6">
                          <select class="select2" name="customer_type" id="customer_type">
                              <option value='user' {{ $result->customer_type == 'user' ? 'selected':"" }}>{{ __('User') }}</option>
                              <option value='merchant' {{ $result->customer_type == 'merchant' ? 'selected':"" }}>{{ __('Merchant') }}</option>
                          </select>
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                          <label class="col-sm-3 control-label mt-11 f-14 fw-bold text-sm-end"></label>
                          <div class="col-sm-5">
                  ...
                  <div class="box-footer">
                      <a class="btn btn-theme-danger f-14" href="{{ url(config('adminPrefix').'/settings/user_role') }}">{{ __('Cancel') }}</a>
...
<script type="text/javascript">
    ...
    function checkUserRolePermissionsOnUpdate()
    {
        ...
        .done(function(response)
        {
            ...
            {
                let tr = '';
                let stored_permissions = response.stored_permissions.join();
