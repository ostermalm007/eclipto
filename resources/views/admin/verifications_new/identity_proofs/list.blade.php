        ...
        <div class="card-body table-responsive f-14">
            <table class="table table-striped table-hover dt-responsive" id="dataTableBuilder" width="100%" cellspacing="0">
                ...
                <tr>
                    ...
                    <th title="Number">Identity Number</th>
                ...
                @forelse($rows as $row)
                    ...
                    <tr>
                        ...
                        <td class="text-uppercase">{{ str_replace('_',' ',$row['identity_type']) }}</td>
                        <td>
                            {{ $row['identity_number'] }}
                        </td>
                        <td>
...
@section('extra_body_scripts')
    ...
    <script>
            ...
            $(".form-select").on("change", function(event) {
                ...
                $.ajax({
                    url: "{{ url(config('adminPrefix').'/identity-proofs/update') }}", // Replace with your server endpoint
                    type: "POST",
                    data: formData,
