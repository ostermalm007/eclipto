...
@section('styles')
<link rel="stylesheet" href="{{ asset('public/frontend/templates/css/toastr.min.css') }}">
@endsection
@section('content')
    <!-- Login section start -->
...
<script src="{{ asset('public/frontend/templates/js/toastr.min.js') }}" type="text/javascript"></script>
...
<script src="{{ asset('public/frontend/customs/js/login/login.min.js') }}" type="text/javascript"></script>
