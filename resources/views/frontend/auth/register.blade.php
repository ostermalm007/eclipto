            ...
            <div class="col-md-6 offset-md-3">
                ...
                <div class="auth-section d-flex align-items-center create-account">
                      ...
                      <div class="d-flex align-items-center back-direction mb-2 back-signin">
                        ...
                        <form action="{{ route('register.store') }}" class="form-horizontal" id="personal-info-form" method="POST" target="_blank">
                            @csrf
                            <input type="hidden" name="defaultCountry" id="defaultCountry" class="form-control" value="{{ old('defaultCountry')}}">
                            <input type="hidden" name="carrierCode" id="carrierCode" class="form-control" value="{{ old('carrierCode')}}">
                            <input type="hidden" name="formattedPhone" id="formattedPhone" class="form-control" value="{{old
                            ('formattedPhone')}}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="tel" class="form-control" id="phone" name="phone" value="{{ old('formattedPhone')}}" >
                                        
                                        @error('phone')
                                            <span id="duplicate-phone-error" class="error"> {{ $message }} </span>
                                        @else
                                    ...
                                    <div class="form-check mb-3">
                                        <input class="form-check-input" type="checkbox" id="check1" name="agree_terms_conditions" value="something" required>
                                        <label class="form-check-label" for="check1">I agree on <a href="{{ url('/terms-and-conditions') }}" target="_blank" class="text-info">Terms and Conditions</a> </label>
                                    </div>
                                    ...
                                    <div class="d-grid mb-3 mb-3p">
                                        <button class="btn btn-lg btn-primary" type="submit" id="registrationSubmitBtn">
                                            ...
                                            <span class="px-1" id="registrationSubmitBtnTxt">{{ __('Register') }}</span>
