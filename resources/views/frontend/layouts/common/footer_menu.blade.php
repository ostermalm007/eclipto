<!-- Footer section -->
{{-- {{ request()->is('login') || request()->is('forget-password') || request()->is('register') || request()->is('register/store-personal-info') || request()->is('2fa') || request()->is('google2fa') ? 'd-none' : '' }} --}}
	<div class="footer-sec ">
		<div class="px-240">
			<div class="row">
				<div class="col-md-5 pb-54 align-center">
					<a class="d-flex" href="{{ url('/')}}">
						<img class="mt-54 footer-logo" src="{{ asset('/public/assets') }}/images/logo/logo.svg" height="80px" alt="Eclipto">
					</a>
				...
				<div class="col-md-3 align-center">
					...
					<div class="mt-18">
						<ul class="links gilroy-light">
							...
							<li><a href="{{ url('crypto-exchange/create') }}" class="poppins5">{{ __('Exchange') }}</a></li>
							<li><a href="{{ url('/blogs') }}" class="poppins5">{{ __('Blogs') }}</a></li>
	...
	<div class="{{ request()->is('login') || request()->is('forget-password') || request()->is('register') || request()->is('register/store-personal-info') || request()->is('2fa') || request()->is('google2fa') ? 'd-none' : '' }} bottom-footer">
		<div class="px-240 d-flex justify-content-between btn-footer align-center">
			...
			<div>
				<p  class="d-flex align-center justify-center-res sp mt-2 text-white">Developed By AI-ML Developers</p>
			</div>
			{{-- <div>
