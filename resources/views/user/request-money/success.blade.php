...
<div class="bg-white pxy-62 shadow">
    ...
    <p class="mb-0 text-center f-18 gilroy-medium text-dark dark-5B mt-2">{{ __('Request Sent Complete') }}</p>
    ...
    <p class="mb-0 text-center f-14 gilroy-medium text-gray dark-CDO mt-6 r-mt-8 leading-25">{{ __('Money request sent successfully.') }}</p>
    ...
    <div class="print-mail mt-4">
        <div class="d-flex gap-18 justify-content-center">
            ...
            <div class="d-flex">
                <div class="mt-26">
                    <p class="mb-0 text-dark gilroy-medium f-16 theme-font">{{ !empty($receiverName) ? $receiverName : $transInfo['email'] }}</p>
    ...
    <div class="d-flex justify-content-center mt-32 r-mt-20">
        ...
        <a href="{{ route('user.request_money.create') }}" class="bg-white repeat-btn d-flex justify-content-center align-items-center ml-20">
            <span class="gilroy-medium">{{ __('Request Again') }}</span>                        
        </a>
    </div>
</div>
@endsection
